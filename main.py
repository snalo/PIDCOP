...
PIXEL_OO_1 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 500, RECONFIG: [],
               VDP_TYPE: 'PIXEL_OO', NAME: 'PIXEL_OO_1', PRECISION: 4, BITRATE: 1}]
# PIXEL_OO_5 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 100, RECONFIG: [],
#                VDP_TYPE: 'PIXEL_OO', NAME: 'PIXEL_OO_5', PRECISION: 4, BITRATE: 5}]
# PIXEL_OO_10 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 50, RECONFIG: [],
#                VDP_TYPE: 'PIXEL_OO', NAME: 'PIXEL_OO_10', PRECISION: 4, BITRATE: 10}]

# SPOGA_1 = [{ELEMENT_SIZE: 249, ELEMENT_COUNT: 16, UNITS_COUNT: 70, RECONFIG: [],
#            VDP_TYPE: 'SPOGA', NAME: 'SPOGA_1', PRECISION: 8, BITRATE: 1}]


# tpc_list = [PIDCOP_1, PIDCOP_5, PIDCOP_10, DEAPCNN_1, DEAPCNN_5,
#              DEAPCNN_10, HOLYLIGHT_1, HOLYLIGHT_5, HOLYLIGHT_10,
#              PIXEL_OO_1, PIXEL_OO_5, PIXEL_OO_10, PIXEL_EO_1, PIXEL_EO_5, PIXEL_EO_10]
