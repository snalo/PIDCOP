...
def run(modelName, cnnModelDirectory, accelerator_config, required_precision=4):
    ...
    print("hardware Utilization  ->", hardware_utilization)
...
# PIDCOP_1 = [{ELEMENT_SIZE: 8, ELEMENT_COUNT: 193, UNITS_COUNT: 250, RECONFIG: [], VDP_TYPE: 'PIDCOP', NAME: 'PIDCOP_1', PRECISION: 8, BITRATE: 1}]
# PIDCOP_5 = [{ELEMENT_SIZE: 8, ELEMENT_COUNT: 160, UNITS_COUNT: 250, RECONFIG: [], VDP_TYPE: 'PIDCOP', NAME: 'PIDCOP_5', PRECISION: 8, BITRATE: 5}]
# PIDCOP_10 = [{ELEMENT_SIZE: 8, ELEMENT_COUNT: 146, UNITS_COUNT: 250, RECONFIG: [],VDP_TYPE: 'PIDCOP', NAME: 'PIDCOP_10', PRECISION: 8, BITRATE: 10}]
# DEAPCNN_1 = [{ELEMENT_SIZE: 15, ELEMENT_COUNT: 15, UNITS_COUNT: 200, RECONFIG: [], VDP_TYPE: 'DEAPCNN', NAME: 'DEAPCNN_1', PRECISION: 4, BITRATE: 1}]
# DEAPCNN_5 = [{ELEMENT_SIZE: 15, ELEMENT_COUNT: 15, UNITS_COUNT: 47, RECONFIG: [], VDP_TYPE:'DEAPCNN', NAME:'DEAPCNN_5', PRECISION:4, BITRATE: 5}]
# DEAPCNN_10 = [{ELEMENT_SIZE: 12, ELEMENT_COUNT: 12, UNITS_COUNT: 13, RECONFIG: [], VDP_TYPE:'DEAPCNN', NAME:'DEAPCNN_10', PRECISION:4, BITRATE: 10}]
# HOLYLIGHT_1 = [{ELEMENT_SIZE: 43, ELEMENT_COUNT: 43, UNITS_COUNT: 180, RECONFIG: [], VDP_TYPE:'HOLYLIGHT', NAME:'HOLYLIGHT_1', PRECISION:4, BITRATE: 1}]
# HOLYLIGHT_5 = [{ELEMENT_SIZE: 21, ELEMENT_COUNT: 21, UNITS_COUNT: 35, RECONFIG: [], VDP_TYPE:'HOLYLIGHT', NAME:'HOLYLIGHT_5', PRECISION:4, BITRATE: 5}]
# HOLYLIGHT_10 = [{ELEMENT_SIZE: 17, ELEMENT_COUNT: 17, UNITS_COUNT: 9, RECONFIG: [], VDP_TYPE:'HOLYLIGHT', NAME:'HOLYLIGHT_10', PRECISION:4, BITRATE: 10}]
# PIXEL_EO_1 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 200, RECONFIG: [], VDP_TYPE: 'PIXEL_EO', NAME: 'PIXEL_EO_1', PRECISION: 4, BITRATE: 1}]
# PIXEL_EO_5 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 100, RECONFIG: [], VDP_TYPE: 'PIXEL_EO', NAME: 'PIXEL_EO_5', PRECISION: 4, BITRATE: 5}]
# PIXEL_EO_10 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 50, RECONFIG: [], VDP_TYPE: 'PIXEL_EO', NAME: 'PIXEL_EO_10', PRECISION: 4, BITRATE: 10}]

PIDCOP_1 = [{ELEMENT_SIZE: 8, ELEMENT_COUNT: 180, UNITS_COUNT: 250, RECONFIG: [], VDP_TYPE: 'PIDCOP', NAME: 'PIDCOP_1', PRECISION: 8, BITRATE: 1}]
# PIDCOP_5 = [{ELEMENT_SIZE: 8, ELEMENT_COUNT: 118, UNITS_COUNT: XXX, RECONFIG: [], VDP_TYPE: 'PIDCOP', NAME: 'PIDCOP_5', PRECISION: 8, BITRATE: 5}]
# PIDCOP_10 = [{ELEMENT_SIZE: 8, ELEMENT_COUNT: 91, UNITS_COUNT: 250, RECONFIG: [],VDP_TYPE: 'PIDCOP', NAME: 'PIDCOP_10', PRECISION: 8, BITRATE: 10}]
DEAPCNN_1 = [{ELEMENT_SIZE: 15, ELEMENT_COUNT: 15, UNITS_COUNT: 135, RECONFIG: [], VDP_TYPE: 'DEAPCNN', NAME: 'DEAPCNN_1', PRECISION: 4, BITRATE: 1}]
# DEAPCNN_5 = [{ELEMENT_SIZE: 15, ELEMENT_COUNT: 15, UNITS_COUNT: XXX, RECONFIG: [], VDP_TYPE:'DEAPCNN', NAME:'DEAPCNN_5', PRECISION:4, BITRATE: 5}]
# DEAPCNN_10 = [{ELEMENT_SIZE: 12, ELEMENT_COUNT: 12, UNITS_COUNT: XXX, RECONFIG: [], VDP_TYPE:'DEAPCNN', NAME:'DEAPCNN_10', PRECISION:4, BITRATE: 10}]
HOLYLIGHT_1 = [{ELEMENT_SIZE: 43, ELEMENT_COUNT: 43, UNITS_COUNT: 50, RECONFIG: [], VDP_TYPE:'HOLYLIGHT', NAME:'HOLYLIGHT_1', PRECISION:4, BITRATE: 1}]
# HOLYLIGHT_5 = [{ELEMENT_SIZE: 21, ELEMENT_COUNT: 21, UNITS_COUNT: XX, RECONFIG: [], VDP_TYPE:'HOLYLIGHT', NAME:'HOLYLIGHT_5', PRECISION:4, BITRATE: 5}]
# HOLYLIGHT_10 = [{ELEMENT_SIZE: 17, ELEMENT_COUNT: 17, UNITS_COUNT: XX, RECONFIG: [], VDP_TYPE:'HOLYLIGHT', NAME:'HOLYLIGHT_10', PRECISION:4, BITRATE: 10}]
PIXEL_EO_1 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 500, RECONFIG: [], VDP_TYPE: 'PIXEL_EO', NAME: 'PIXEL_EO_1', PRECISION: 4, BITRATE: 1}]
# PIXEL_EO_5 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: XX, RECONFIG: [], VDP_TYPE: 'PIXEL_EO', NAME: 'PIXEL_EO_5', PRECISION: 4, BITRATE: 5}]
# PIXEL_EO_10 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: XX, RECONFIG: [], VDP_TYPE: 'PIXEL_EO', NAME: 'PIXEL_EO_10', PRECISION: 4, BITRATE: 10}]
PIXEL_OO_1 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 500, RECONFIG: [], VDP_TYPE: 'PIXEL_OO', NAME: 'PIXEL_OO_1', PRECISION: 4, BITRATE: 1}]
# PIXEL_OO_5 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 100, RECONFIG: [], VDP_TYPE: 'PIXEL_OO', NAME: 'PIXEL_OO_5', PRECISION: 4, BITRATE: 5}]
# PIXEL_OO_10 = [{ELEMENT_SIZE: 4, ELEMENT_COUNT: 4, UNITS_COUNT: 50, RECONFIG: [], VDP_TYPE: 'PIXEL_OO', NAME: 'PIXEL_OO_10', PRECISION: 4, BITRATE: 10}]

# SPOGA_1 = [{ELEMENT_SIZE: 249, ELEMENT_COUNT: 16, UNITS_COUNT: 70, RECONFIG: [],VDP_TYPE: 'SPOGA', NAME: 'SPOGA_1', PRECISION: 8, BITRATE: 1}]


# tpc_list = [PIDCOP_1, PIDCOP_5, PIDCOP_10, DEAPCNN_1, DEAPCNN_5,DEAPCNN_10, HOLYLIGHT_1, HOLYLIGHT_5, HOLYLIGHT_10, PIXEL_OO_1, PIXEL_OO_5, PIXEL_OO_10, PIXEL_EO_1, PIXEL_EO_5, PIXEL_EO_10]

tpc_list = [PIDCOP_1, DEAPCNN_1, HOLYLIGHT_1, PIXEL_OO_1, PIXEL_EO_1] #mobilenet
...
#modelList = ['MobileNet_V2.csv','ShuffleNet_V2.csv','ResNet50.csv']
# modelList = ['MobileNet_V2.csv','ShuffleNet_V2.csv']
modelList = ['VGG16.csv']
...
#sys_level_results_df.to_csv('Result/ALL_Archi_02_17_.csv')
sys_level_results_df.to_csv('Result/ALL_Archi_03_07_RDPvgg16.csv')
